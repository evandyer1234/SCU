namespace Helpers
{
    public class NamingConstants
    {
        ...
        public const string TAG_LENS_RIGHT = "LensRight";
        public const string TAG_MAGNIFYING_GLASS_SHADOW = "MagnifyingGlassShadow";
        public const string TAG_MAGNIFYING_GLASS = "MagnifyingGlass";
