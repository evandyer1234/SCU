...
public class TabbedMenuController
{
    ...
    public void RegisterTabCallbacks()
    {
        ...
        {
            tab.RegisterCallback<UnityEngine.UIElements.ClickEvent>(TabOnClick);
        });
    }

    /* Method for the tab on-click event:
 
       - If it is not selected, find other tabs that are selected, unselected them
       - Then selected the tab that was clicked on
    */
    private void TabOnClick(UnityEngine.UIElements.ClickEvent evt)
    {
